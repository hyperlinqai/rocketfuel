                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <motion.h1 variants={fadeInUp} className="hero-title">
                            Powering Payments for the <br className="hidden lg:block" />
                            <span className="text-gradient-gold">
                                World’s Most Dynamic Marketplaces
                            </span>
                        </motion.h1>

                        <motion.p variants={fadeInUp} className="hero-description">
                            RocketFuel helps marketplaces of every kind accept crypto, manage seller payouts, and streamline global transactions — all through a single, compliant payment infrastructure.
                        </motion.p>
                    ...
                    {/* Hero Visual: Digital Marketplace Network */}
                    <motion.div
                    ...
                    >
                        {/* Central Marketplace Hub Visual */}
                        <div className="relative w-full aspect-square max-w-md mx-auto">
                            ...
                            >
                                <Layout className="w-12 h-12 text-orange-600" />
                            </motion.div>

                            {/* Orbiting Nodes (Buyers/Sellers) */}
                            {[
                                { icon: ShoppingBag, color: "bg-blue-100 text-blue-600", angle: 0, label: "Buyer" },
                                { icon: Users, color: "bg-green-100 text-green-600", angle: 72, label: "Seller" },
                                { icon: Globe, color: "bg-purple-100 text-purple-600", angle: 144, label: "Global" },
                                { icon: Wallet, color: "bg-pink-100 text-pink-600", angle: 216, label: "Payout" },
    ...
    const benefits = [
        {
            ...
            desc: "Accept major cryptocurrencies and stablecoins from buyers worldwide without friction.",
            icon: Coins
        },
        {
            title: "Instant Seller Payouts",
            desc: "Pay sellers, vendors, or service providers in their preferred currency instantly.",
            icon: Zap
        },
        {
            title: "Wallet Management",
            desc: "Enable users to fund wallets, tip creators, and redeem balances in real time.",
            icon: Wallet
        },
        {
            title: "Global Compliance",
            desc: "All payments routed through regulated partners with built-in AML, KYC, and OFAC.",
            icon: ShieldCheck
        }
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                        Accept Payments, Pay Sellers, and Scale Globally
                    </h2>
                    <p className="text-lg text-gray-600">
                        Online marketplaces face unique challenges managing multi-party transactions, global users, and complex settlement flows. RocketFuel simplifies every payment and payout with a unified platform for crypto, stablecoin, and fiat processing.
                    </p>
                </div>
        ...
        <section className="py-24 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900">A Seamless End-to-End Payment Ecosystem</h2>
                </div>
                ...
                <div className="relative grid md:grid-cols-4 gap-8 text-center z-10">
                    ...
                    {[
                        { step: "01", title: "Accept Payments", desc: "Buyers purchase using crypto, stablecoins, or fiat.", icon: ShoppingBag },
                        { step: "02", title: "Manage Balances", desc: "Platform manages purchases, tips, & transactions.", icon: Layers },
                        { step: "03", title: "Send Payouts", desc: "Sellers receive instant payouts in local currency.", icon: Zap },
                        { step: "04", title: "Settle Automatically", desc: "RocketFuel handles conversion & reconciliation.", icon: RefreshCw }
                    ].map((step, i) => (
                        <motion.div
                            key={i}
                ...
                <div className="text-center mt-12 text-gray-500 text-sm">
                    Perfect for multi-vendor marketplaces, subscription-based platforms, and user-generated content ecosystems.
                </div>
            </div>
        </section>
    );
    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Built for Platforms That Connect Buyers and Sellers</h2>
                        <p className="text-lg text-gray-600 mb-8">
                            RocketFuel supports digital and physical marketplaces across commerce, services, and media. Whether you manage e-commerce, digital content, or community-driven sales, our infrastructure scales to fit your needs.
                        </p>
                        <ul className="space-y-4">
                            {[
                                "E-commerce and retail marketplaces",
                                "Peer-to-peer resale and consignment",
                                "Subscription or membership-based platforms",
                                "Digital goods and content marketplaces",
                                "Tipping and value-for-value systems"
                            ].map((item, i) => (
                    ...
                    <div className="relative">
                        <div className="bg-gray-900 rounded-2xl shadow-2xl p-6 text-white border border-gray-800">
                            <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-800">
                                ...
                                <div className="text-xs text-gray-400">Marketplace Revenue</div>
                            </div>

                            <div className="grid grid-cols-3 gap-3 mb-6">
                                {[
                                    { label: "Gross Volume", val: "$2.4M", trend: "+12%" },
                                    { label: "Net Revenue", val: "$450k", trend: "+8%" },
                                    { label: "Payouts", val: "$1.8M", trend: "+14%" }
                                ].map((stat, i) => (
                            ...
                            <div className="space-y-3">
                                <div className="text-xs text-gray-500 uppercase tracking-widest mb-2">Recent Transactions by Category</div>
                                {[
                                    { name: "Digital Goods", amount: "$850.00", type: "Purchase", icon: ShoppingBag },
                                    { name: "Creator Tips", amount: "$120.00", type: "Tipping", icon: Coins },
                                    { name: "Subscription", amount: "$45.00", type: "Recurring", icon: RefreshCw },
                                    { name: "Service Fee", amount: "$250.00", type: "Escrow", icon: ShieldCheck },
                                ].map((row, i) => (
        ...
        <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">Global Reach, Built-In Compliance</h2>
                    <p className="text-lg text-gray-400">
                        RocketFuel’s payment system ensures that every transaction is transparent, traceable, and fully compliant with international regulations.
                    </p>
                </div>

                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        { title: "Regulated Partners", desc: "Regulated exchange and banking partners for fund movement.", icon: Globe },
                        { title: "Automated KYC/KYT", desc: "Real-time checks for sellers and payees.", icon: Users },
                        { title: "ZeroProof Verify", desc: "Optional age verification for restricted platforms.", icon: ShieldCheck },
                        { title: "Audit Ready", desc: "Blockchain-based records for complete reconciliation.", icon: BarChart3 }
                    ].map((item, i) => (
    ...
    return (
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Drive Growth and Unlock New Revenue</h2>
                <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
                    RocketFuel gives marketplaces, PSPs, and integrators a flexible way to manage payments while earning from every transaction.
                </p>

                <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    {[
                        { text: "Shared transaction revenue and flexible integrations", icon: Coins },
                        { text: "White-label capability for marketplace operators", icon: Layout },
                        { text: "Full analytics suite for payouts and refunds", icon: BarChart3 },
                        { text: "Global coverage for stablecoin & fiat settlements", icon: Globe }
                    ].map((feature, i) => (
    ...
    return (
        <section className="py-24 bg-gradient-to-br from-yellow-500 to-orange-600 text-white relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                <h2 className="text-4xl md:text-5xl font-bold mb-6">One Platform for Payments, Payouts, and Growth</h2>
                <p className="text-xl text-yellow-100 mb-10 max-w-2xl mx-auto">
                    From digital goods to physical marketplaces, RocketFuel gives you the tools to process payments, pay sellers instantly, and expand globally.
                </p>
